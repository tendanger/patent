...
for j in range(1, 11):
    ...
    #打印合并信息
    #print('-' * 180)
    c2 = id_2 + date_2 + title_2_one + holder_2_one + ipc_2_one + group_2
    print(c2)
    print("2" + '-' * 180)
    #################
    #第3条专利信息
    ...
    #打印合并信息
    #print('-' * 180)
    c4 = id_4 + date_4 + title_4_one + holder_4_one + ipc_4_one + group_4
    print(c4)
    print("4" + '-' * 180)
    ######################
    #5
    ...
    #打印合并信息
    #print('-' * 180)
    c5 = id_5 + date_5 + title_5_one + holder_5_one + ipc_5_one + group_5
    print(c5)
    print("5" + '-' * 180)
    #########
    #6
